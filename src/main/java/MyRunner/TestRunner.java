...
@RunWith(Cucumber.class)
@CucumberOptions(
		features="src/main/java/Features/Tagging.feature", 		//the path of feature file
		...
		//tags = {"@SmokeTest" , "@FunctionalTest"}					// And Condition
		tags = {"@SmokeTest, @FunctionalTest"}						// or condition
		)
